...
| UX-1 | Core states, accessibility, and responsive layout are usable | Pass locally | 9 demo tests cover strict-sample identity, full sample recovery, validation, presentation, and SSR; browser exercised success/error-capable controls at desktop and 390×844; labels, skip link, live regions, focus styles, 42px+ controls, and clean console were inspected | A formal third-party WCAG audit and production-host canary are not claimed |
